...
def generate_launch_description():
    moveit_config = (
        MoveItConfigsBuilder(
            robot_name="robot", package_name="robot_moveit_config"
        )
    ...
    package_name_gazebo = 'robot_moveit_config'
    default_robot_name = 'robot'
    rviz_config_file_path = 'config/moveit.rviz'
    urdf_file_path = '/home/prasannan-robot/Desktop/Papi/ros2_ws/src/GANTRY_ROBOT_CONTROL_ROS2/robot_moveit_config/config/robot.urdf.xacro'
    ...
    return LaunchDescription(
        [
            ...
            control_node,load_joint_state_broadcaster_cmd,
