...
def generate_launch_description():
  ...
  package_name_gazebo = 'hath'
 
  default_robot_name = 'hath'
  gazebo_launch_file_path = 'launch'
  gazebo_models_path = 'models'
  rviz_config_file_path = 'rviz/urdf_config.rviz'
  urdf_file_path = 'src/description/robot.urdf'
  world_file_path = 'world/empty.world' # e.g. 'world/empty.world', 'world/house.world'
